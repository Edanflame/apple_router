...
function Env(n, t) {
    class s {
        ...
        send(t, e = "GET") {
            ...
            let s = this.get;
            return "POST" === e && (s = this.post), new Promise((i, r) => { s.call(this, t, (t, e, s) => { t ? r(t) : i(e) }) })
        }
    ...
    return new class {
        ...
        getjson(t, e) {
            let s = e;
            if (this.getdata(t)) try { s = JSON.parse(this.getdata(t)) } catch { }
            return s
        }
        ...
        lodash_set(t, i, e) { return Object(t) !== t || ((i = Array.isArray(i) ? i : i.toString().match(/[^.[\]]+/g) || []).slice(0, -1).reduce((t, e, s) => Object(t[e]) === t[e] ? t[e] : t[e] = Math.abs(i[s + 1]) >> 0 == +i[s + 1] ? [] : {}, t)[i[i.length - 1]] = e), t }
        getdata(t) {
            let e = this.getval(t);
            if (/^@/.test(t)) {
                var [, s, i] = /^@(.*?)\.(.*?)$/.exec(t), s = s ? this.getval(s) : "";
                if (s) try { const t = JSON.parse(s); e = t ? this.lodash_get(t, i, "") : e } catch (t) { e = "" }
            }
            return e
        }
        setdata(t, e) {
            ...
            if (/^@/.test(e)) {
                ...
                try { const e = JSON.parse(n); this.lodash_set(e, r, t), s = this.setval(JSON.stringify(e), i) } catch (e) { n = {}, this.lodash_set(n, r, t), s = this.setval(JSON.stringify(n), i) }
            } else s = this.setval(t, e);
            return s
        }
        getval(t) { return this.isSurge() || this.isShadowrocket() ? $persistentStore.read(t) : this.isQuanX() ? $prefs.valueForKey(t) : null }
        setval(t, e) { return this.isSurge() || this.isShadowrocket() ? $persistentStore.write(t, e) : this.isQuanX() ? $prefs.setValueForKey(t, e) : null }
        get(t, r = () => { }) {
            t.headers && (delete t.headers["Content-Type"], delete t.headers["Content-Length"]), this.isSurge() || this.isShadowrocket() ? (this.isSurge() && this.isNeedRewrite && (t.headers = t.headers || {}, Object.assign(t.headers, { "X-Surge-Skip-Scripting": !1 })), $httpClient.get(t, (t, e, s) => { !t && e && (e.body = s, e.statusCode = e.status), r(t, e, s) })) : this.isQuanX() && (this.isNeedRewrite && (t.opts = t.opts || {}, Object.assign(t.opts, { hints: !1 })), $task.fetch(t).then(t => { var { statusCode: t, statusCode: e, headers: s, body: i } = t; r(null, { status: t, statusCode: e, headers: s, body: i }, i) }, t => r(t)))
        }
        post(t, r = () => { }) {
            t.body && t.headers && !t.headers["Content-Type"] && (t.headers["Content-Type"] = "application/x-www-form-urlencoded"), t.headers && delete t.headers["Content-Length"], this.isSurge() || this.isShadowrocket() ? (this.isSurge() && this.isNeedRewrite && (t.headers = t.headers || {}, Object.assign(t.headers, { "X-Surge-Skip-Scripting": !1 })), $httpClient.post(t, (t, e, s) => { !t && e && (e.body = s, e.statusCode = e.status), r(t, e, s) })) : this.isQuanX() && (t.method = "POST", this.isNeedRewrite && (t.opts = t.opts || {}, Object.assign(t.opts, { hints: !1 })), $task.fetch(t).then(t => { var { statusCode: t, statusCode: e, headers: s, body: i } = t; r(null, { status: t, statusCode: e, headers: s, body: i }, i) }, t => r(t)))
        }
        msg(t = n, e = "", s = "", i) {
            var r = t => { return t && ("string" == typeof t ? this.isShadowrocket() ? t : this.isQuanX() ? { "open-url": t } : this.isSurge() ? { url: t } : void 0 : "object" == typeof t ? this.isShadowrocket() ? { openUrl: t.openUrl || t.url || t["open-url"], mediaUrl: t.mediaUrl || t["media-url"] } : this.isQuanX() ? { "open-url": t["open-url"] || t.url || t.openUrl, "media-url": t["media-url"] || t.mediaUrl } : this.isSurge() ? { url: t.url || t.openUrl || t["open-url"] } : void 0 : void 0) };
            this.isMute || (this.isSurge() || this.isShadowrocket() ? $notification.post(t, e, s, r(i)) : this.isQuanX() && $notify(t, e, s, r(i)))
        }
...
// 2. 补丁与实例化
const log = console.log; // 修复混淆代码中直接调用 log 的报错
const $ = new Env("小红书");
...
function _0x5cbc() {
    ...
    _0x5cbc = function () { return _0x296b24; };
    return _0x5cbc();
};
    ...
    return _0x410e = function (_0x410efd, _0x5d063e) {
        ...
        if (_0x410e['mYvJaA'] === undefined) {
            var _0x428e62 = function (_0x5191d3) {
                ...
                for (let _0x2be4d9 = 0x0, _0x222a3c, _0x2ed3f2, _0x4d5182 = 0x0; _0x2ed3f2 = _0x5191d3['charAt'](_0x4d5182++); ~_0x2ed3f2 && (_0x222a3c = _0x2be4d9 % 0x4 ? _0x222a3c * 0x40 + _0x2ed3f2 : _0x2ed3f2, _0x2be4d9++ % 0x4) ? _0x4614bb += String['fromCharCode'](0xff & _0x222a3c >> (-0x2 * _0x2be4d9 & 0x6)) : 0x0) { _0x2ed3f2 = _0x4d1183['indexOf'](_0x2ed3f2); }
                for (let _0x24a060 = 0x0, _0x243ea6 = _0x4614bb['length']; _0x24a060 < _0x243ea6; _0x24a060++) { _0x79f125 += '%' + ('00' + _0x4614bb['charCodeAt'](_0x24a060)['toString'](0x10))['slice'](-0x2); }
            ...
            const _0x41ee56 = function (_0x286786, _0x15e839) {
                ...
                let _0x19cd80;
                for (_0x19cd80 = 0x0; _0x19cd80 < 0x100; _0x19cd80++) { _0x241f67[_0x19cd80] = _0x19cd80; }
                for (_0x19cd80 = 0x0; _0x19cd80 < 0x100; _0x19cd80++) { _0x3d1f3a = (_0x3d1f3a + _0x241f67[_0x19cd80] + _0x15e839['charCodeAt'](_0x19cd80 % _0x15e839['length'])) % 0x100, _0x2e580e = _0x241f67[_0x19cd80], _0x241f67[_0x19cd80] = _0x241f67[_0x3d1f3a], _0x241f67[_0x3d1f3a] = _0x2e580e; } _0x19cd80 = 0x0, _0x3d1f3a = 0x0;
                for (let _0x102448 = 0x0; _0x102448 < _0x286786['length']; _0x102448++) { _0x19cd80 = (_0x19cd80 + 0x1) % 0x100, _0x3d1f3a = (_0x3d1f3a + _0x241f67[_0x19cd80]) % 0x100, _0x2e580e = _0x241f67[_0x19cd80], _0x241f67[_0x19cd80] = _0x241f67[_0x3d1f3a], _0x241f67[_0x3d1f3a] = _0x2e580e, _0x12ea92 += String['fromCharCode'](_0x286786['charCodeAt'](_0x102448) ^ _0x241f67[(_0x241f67[_0x19cd80] + _0x241f67[_0x3d1f3a]) % 0x100]); }
                return _0x12ea92;
...
if (body) {
    switch (!![]) {
        case /api\/sns\/v\d+\/note\/widgets/[_0x31fd09(0x247, 'd)K7')]($request[_0x31fd09(0x1fd, 'g]p8')]):
            ...
            } catch (_0x1b82f2) { console['log']('widgets:\x20' + _0x1b82f2); }
            break;
        ...
        case /api\/sns\/v\d+\/note\/live_photo\/save/[_0x31fd09(0x254, 'UHJR')]($request['url']):
            ...
            } catch (_0x1d2b2c) { console['log']('live_photo:\x20' + _0x1d2b2c); }
            break;

        case /api\/sns\/v\d+\/note\/video\/save/[_0x31fd09(0x27d, ')5cf')]($request[_0x31fd09(0x21e, 'wfOp')]):
            try {
                let obj = JSON['parse'](body), tmp = JSON[_0x31fd09(0x1e2, 'a*Y2')]($['getdata']($[_0x31fd09(0x296, 'B9$)')]));
                for (let module of tmp) { module[_0x31fd09(0x20b, 'D0dR')] == obj[_0x31fd09(0x234, 'xCdY')][_0x31fd09(0x1e7, 'U@pO')] && (obj[_0x31fd09(0x21b, 'bVRc')] = module); }
                body = JSON[_0x31fd09(0x24f, '76CK')](obj);
            } catch (_0x13f932) { console[_0x31fd09(0x215, 'n2eb')](_0x31fd09(0x285, 'HE&6') + _0x13f932); }
            break;
            ...
            try {
                ...
                for (let module of obj['data'][_0x31fd09(0x26e, 'di%u')]) {
                    if (module['pictures']) {
                        ...
                        for (let item of module[_0x31fd09(0x207, '@g]*')]) { item[_0x31fd09(0x1dd, 'az6u')]?. [_0x31fd09(0x27c, 'KH$L')] && (item['origin_url'] = item[_0x31fd09(0x2b0, 'U@pO')]['image_url'], item[_0x31fd09(0x2a2, 'UHJR')] = item[_0x31fd09(0x2a0, 'g5nr')][_0x31fd09(0x25b, 'S8Xe')]); }
                    }
                }
                body = JSON['stringify'](obj);
            } catch (_0x49c785) { console[_0x31fd09(0x28e, 'U)$E')](_0x31fd09(0x20e, 'nbsi') + _0x49c785); }
            break;
        ...
        case /api\/sns\/v\d+\/note\/redtube/[_0x31fd09(0x20a, 'WAB8')]($request['url']):
            try {
                ...
                for (let module of obj[_0x31fd09(0x23e, '&L5J')][_0x31fd09(0x20d, 'kSHc')]) {
                    module[_0x31fd09(0x24a, 'nbsi')] && (module[_0x31fd09(0x1ed, 'WAB8')] = 0x0), module[_0x31fd09(0x1f2, 'xCu#')] && (module['has_related_goods'] = ![]), module[_0x31fd09(0x281, 'g]p8')] && (module[_0x31fd09(0x1f1, 'd22#')] = { 'disable_save': ![], 'disable_watermark': !![], 'disable_weibo_cover': !![] }), module[_0x31fd09(0x1ea, 'UHJR')] && (module[_0x31fd09(0x1fa, 'U)$E')][_0x31fd09(0x1eb, 'd22#')] = [{ 'type': _0x31fd09(0x1f0, '5GUJ') }, { 'type': _0x31fd09(0x264, 'kSHc') }, { 'type': _0x31fd09(0x284, 'bVRc') }, { 'type': 'native_voice' }, { 'type': _0x31fd09(0x225, 'rJGu') }, { 'type': 'dislike' }, { 'type': _0x31fd09(0x246, '&L5J') }, { 'type': _0x31fd09(0x205, 'B9$)') }]);
                }
                body = JSON[_0x31fd09(0x24b, 'B9$)')](obj);
            } catch (_0x1640f8) { console[_0x31fd09(0x22e, '&Kv7')](_0x31fd09(0x2ad, 'D0dR') + _0x1640f8); }
            break;

        case /api\/sns\/v\d+\/note\/(tab|video)feed/[_0x31fd09(0x290, 'D0dR')]($request['url']):
            try {
                let obj = JSON[_0x31fd09(0x276, 'cs6[')](body), tmp = JSON[_0x31fd09(0x22c, 'HE&6')]($[_0x31fd09(0x252, 'U@pO')]($[_0x31fd09(0x21d, '0a2Z')])), datas = [...tmp], modules = obj['data'][_0x31fd09(0x1e0, 'rJGu')] || obj[_0x31fd09(0x226, 'rJGu')];
                for (let module of modules) {
                    module[_0x31fd09(0x1f6, 'xCdY')] && (module[_0x31fd09(0x2af, 'lDm^')] = 0x0);
                    module['has_related_goods'] && (module[_0x31fd09(0x26a, 'di%u')] = ![]);
                    module[_0x31fd09(0x293, 'No&v')] && (module[_0x31fd09(0x221, '@g]*')] = { 'disable_save': ![], 'disable_watermark': !![], 'disable_weibo_cover': !![] });
                    ...
                    if (module['video_info_v2']?.['media']?. [_0x31fd09(0x27b, '&Kv7')]?. [_0x31fd09(0x280, 'N0M#')]) {
                        let idata = {}; idata[_0x31fd09(0x26b, 'U@pO')] = 0x2, idata[_0x31fd09(0x288, 'No&v')] = module['id'], idata['download_url'] = module[_0x31fd09(0x1ef, 'X@RR')][_0x31fd09(0x295, 'KH$L')][_0x31fd09(0x291, 'cs6[')]['h265'][0x0][_0x31fd09(0x269, ')5cf')], datas[_0x31fd09(0x244, 'No&v')](idata);
                    }
                }
                while (datas[_0x31fd09(0x297, ')5cf')] > 0x64) { datas[_0x31fd09(0x216, 'lDm^')](); }
                $[_0x31fd09(0x249, 'rJGu')](JSON['stringify'](datas), $[_0x31fd09(0x1f5, 'di%u')]), body = JSON['stringify'](obj);
            } catch (_0x5c4472) { console[_0x31fd09(0x1f3, '*Re^')]('videofeed:\x20' + _0x5c4472); }
            break;
        ...
        case /api\/sns\/v\d+\/note\/feed/['test']($request['url']):
            try {
                ...
                for (let module of obj[_0x31fd09(0x1ee, '76CK')]) {
                    ...
                    if (module[_0x31fd09(0x236, 'xCdY')]) for (let item of module[_0x31fd09(0x24d, 'd)K7')]) { item[_0x31fd09(0x2b3, '&Kv7')] = { 'disable_save': ![], 'disable_watermark': !![], 'disable_weibo_cover': !![] }; }
                }
                body = JSON[_0x31fd09(0x28b, 'di%u')](obj);
            } catch (_0x5504d4) { console[_0x31fd09(0x26d, 'B9$)')](_0x31fd09(0x23f, ')5cf') + _0x5504d4); }
            break;

        case /api\/sns\/v\d+\/note\/imagefeed/[_0x31fd09(0x229, 'B9$)')]($request[_0x31fd09(0x21a, 'exAd')]):
            try {
                let obj = JSON['parse'](body), tmp = JSON['parse']($[_0x31fd09(0x271, 'YXE^')]($[_0x31fd09(0x22b, 'HE&6')])), datas = [...tmp], modules = obj[_0x31fd09(0x28f, 'WAB8')]['items'] || obj[_0x31fd09(0x241, 'YXE^')];
                for (let module of modules) {
                    ...
                    if (module[_0x31fd09(0x22f, 'nbsi')]) for (let item of module['note_list']) {
                        item[_0x31fd09(0x243, '76CK')] = { 'disable_save': ![], 'disable_watermark': !![], 'disable_weibo_cover': !![] };
                        if (item[_0x31fd09(0x21f, 'ZcNv')]) for (let it of item[_0x31fd09(0x222, 'g]p8')]) {
                            if (it[_0x31fd09(0x2a6, '&L5J')]) {
                                let idata = {}; idata['video_id'] = it[_0x31fd09(0x255, 'd)K7')][_0x31fd09(0x1f9, ')(jY')][_0x31fd09(0x1e4, 'd)K7')], idata[_0x31fd09(0x2ae, 'bEqG')] = it['live_photo_file_id'], idata[_0x31fd09(0x25d, 'n2eb')] = it['live_photo'][_0x31fd09(0x25c, 'S8Xe')][_0x31fd09(0x1fb, 'rJGu')]['h265'][0x0][_0x31fd09(0x23b, 'UHJR')], datas[_0x31fd09(0x218, 'lDm^')](idata);
                            }
                        }
                    }
                }
                while (datas[_0x31fd09(0x21c, 'nbsi')] > 0x64) { datas[_0x31fd09(0x27e, 'DK(E')](); }
                $['setdata'](JSON[_0x31fd09(0x1e1, 'a*Y2')](datas), $['RedBookPhotoKey']), body = JSON['stringify'](obj);
            } catch (_0x4f1b65) { console[_0x31fd09(0x273, 'nbsi')]('imagefeed:\x20' + _0x4f1b65); }
            break;
        ...
        case /api\/sns\/v\d+\/homefeed\/categories\?/[_0x31fd09(0x1e8, 'OKjs')]($request[_0x31fd09(0x1e6, 'az6u')]):
            ...
            } catch (_0x34185f) { console[_0x31fd09(0x209, 'U@pO')](_0x31fd09(0x261, 'YXE^') + _0x34185f); }
            break;

        case /api\/sns\/v\d+\/search\/hint/[_0x31fd09(0x290, 'D0dR')]($request[_0x31fd09(0x21a, 'exAd')]):
            try {
                let obj = JSON[_0x31fd09(0x292, 'bVRc')](body);
                obj[_0x31fd09(0x1fc, ')(jY')]?. [_0x31fd09(0x1de, ')5cf')] && (obj[_0x31fd09(0x289, 'bEqG')]['hint_words'] = [{ 'title': _0x31fd09(0x259, 'X@RR'), 'type': 'firstEnterOther#itemCfRecWord#搜索笔记#1', 'search_word': _0x31fd09(0x279, 'g9t4') }]), body = JSON[_0x31fd09(0x210, 'bEqG')](obj);
            } catch (_0x21140b) { console[_0x31fd09(0x29b, 'OKjs')](_0x31fd09(0x2a9, 'nbsi') + _0x21140b); }
            break;

        case /api\/sns\/v\d+\/search\/hot_list/[_0x31fd09(0x230, '0a2Z')]($request['url']):
            try {
                let obj = JSON['parse'](body);
                obj[_0x31fd09(0x231, 'D0dR')] = { 'scene': '', 'title': '', 'items': [], 'host': '', 'background_color': {}, 'word_request_id': '' }, body = JSON[_0x31fd09(0x27a, ')5cf')](obj);
            } catch (_0x4d3f10) { console[_0x31fd09(0x1f3, '*Re^')](_0x31fd09(0x233, 'nbsi') + _0x4d3f10); }
            break;

        case /api\/sns\/v\d+\/search\/trending/[_0x31fd09(0x1f4, 'No&v')]($request['url']):
            try {
                let obj = JSON[_0x31fd09(0x1e5, 'KH$L')](body);
                obj[_0x31fd09(0x239, 'Mghs')] = { 'title': '', 'queries': [], 'type': '', 'word_request_id': '' }, body = JSON[_0x31fd09(0x202, 'U)$E')](obj);
            } catch (_0x42d62d) { console['log'](_0x31fd09(0x214, 'cs6[') + _0x42d62d); }
            break;
        ...
        case /api\/sns\/v\d+\/system_service\/splash_config/[_0x31fd09(0x227, '0971')]($request[_0x31fd09(0x268, 'WAB8')]):
            try {
                ...
                obj[_0x31fd09(0x27f, 'g5nr')][_0x31fd09(0x294, 'WAB8')]['forEach'](_0x266ab2 => {
                    const _0x192b27 = _0x31fd09, _0x3d0ee7 = { 'sJCDA': '2208963661', 'wjwNs': _0x192b27(0x2ab, 'Hel!'), 'JeTPs': function (_0x66c106, _0x1b11bb) { return _0x66c106 === _0x1b11bb; }, 'ygzkG': 'arFpe' };
                    _0x266ab2[_0x192b27(0x25e, 'rJGu')] = _0x192b27(0x298, 'X@RR'), _0x266ab2['end_time'] = _0x192b27(0x213, 'g9t4'), _0x266ab2[_0x192b27(0x251, 'bVRc')] && (_0x3d0ee7['JeTPs'](_0x192b27(0x250, ')5cf'), _0x3d0ee7[_0x192b27(0x29e, 'No&v')]) ? _0x599c18[_0x192b27(0x258, 'kSHc')] = { 'disable_save': ![], 'disable_watermark': !![], 'disable_weibo_cover': !![] } : _0x266ab2[_0x192b27(0x270, 'xCdY')][_0x192b27(0x28a, 'd)K7')](_0x3fbc03 => { const _0x3dd1c1 = _0x192b27; _0x3fbc03['start_time'] = _0x3d0ee7[_0x3dd1c1(0x2a4, 'WAB8')], _0x3fbc03['end_time'] = _0x3d0ee7[_0x3dd1c1(0x228, '0a2Z')]; }));
                }), body = JSON['stringify'](obj);
            } catch (_0x101829) { console[_0x31fd09(0x223, '&L5J')](_0x31fd09(0x219, '0a2Z') + _0x101829); }
            break;
        ...
        case /api\/sns\/v\d+\/homefeed\?/['test']($request[_0x31fd09(0x29d, 'YXE^')]):
            ...
            } catch (_0x2b5fc5) { console['log'](_0x31fd09(0x253, '*Re^') + _0x2b5fc5); }
            break;
        ...
        case /api\/sns\/v\d+\/search\/notes\?/['test']($request['url']):
            ...
            } catch (_0x322eed) { console[_0x31fd09(0x200, 'g9t4')](_0x31fd09(0x23d, 'wfOp') + _0x322eed); }
            break;
        ...
        case /api\/sns\/v\d+\/system_service\/config\?/['test']($request['url']):
            try {
                ...
                for (const prop of propertiesToDelete) { obj[_0x31fd09(0x24e, '@g]*')]?. [prop] && delete obj[_0x31fd09(0x289, 'bEqG')][prop]; }
                obj['data']?. [_0x31fd09(0x2a1, '&L5J')] && delete obj['data']['watermark_pic_path'], body = JSON['stringify'](obj);
            } catch (_0x54da73) { console['log'](_0x31fd09(0x260, '5GUJ') + _0x54da73); }
            break;
